'''
Lower fps for processing to 5 - copy of v4
'''
...
class CAMERAMODEL():
    ...
    def __init__(self):
        ...
        self.camera_config = {
            ...
            "url":"http://127.0.0.1:8000/ai/getcampayload",
            "logdir":"D:\Camduc-Sudisa\paintai\logs",
            "imgdir":"D:\Camduc-Sudisa\paintai\imgs",
            "rtsp_url" : "rtsp://admin:hikvision%23123@192.168.3.45:554/Streaming/channels/101"
        }

        self.counter = ObjectCounter(
            show=False,  # Display the output
            region=self.camera_config['region_points'],  # Pass region points
            model= "D:/Camduc-Sudisa/paintai/streamprocess/cameras/SudisaItem12K.pt",  # model="yolo11n-obb.pt" for object counting using YOLO11 OBB model.
