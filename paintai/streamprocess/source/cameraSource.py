...
class CAMERAMODEL():
    def __init__(self):
        ...
        self.camera_config = {
            ...
            "logdir":"D:",
            "rtsp_url" : "rtsp://admin:hikvision%23123@localhost:554/Streaming/channels/101"
        }
        self.counter = ObjectCounter(
            show=False,  # Display the output
            region=self.camera_config['region_points'],  # Pass region points
            model= "D:/Camduc-Sudisa/paintai/streamprocess/cameras/Iter2.pt",  # model="yolo11n-obb.pt" for object counting using YOLO11 OBB model.
